...
public class CitizenMain {
    public static void main(String[] args) throws ParseException {
        ...
        Passport passportM = new Passport("Иванов","Иван","Иванович","IX-ЖС 706827", formatter.parse("7-Jun-1993"));
        Passport passportW = new Passport("Петрова","Петра","Петровна","XШШ-СФ 567890", formatter.parse("11-Oct-1990"));
